...
public class NanoHTTPD {
	...
	public Response serve(String uri, String method, Properties header,
			Properties parms, Properties files, String ip) {
	 ...
	 * 
	 * try { new NanoHTTPD( port, wwwroot ); } catch( IOException ioe ) {
	...
	private class HTTPSession implements Runnable {
		...
		public void run() {
			try {
				...
				// Ok, now do the serve()
				Response r = serve(uri, method, header, parms, files, mySocket.getInetAddress().getHostAddress());
				if (r == null)
